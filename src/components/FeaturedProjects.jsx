        ...
        {projects.map((project) => {
          ...
          return (
            ...
            >
              ...
              {/* hover overlay */}
              <div className="absolute inset-0 flex items-end p-6 bg-black/0 group-hover:bg-black/10 transition duration-200 ease-out ">
                <h3 className="text-white md:text-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                  {project.name}
                </h3>
              </div>
            </Link>
